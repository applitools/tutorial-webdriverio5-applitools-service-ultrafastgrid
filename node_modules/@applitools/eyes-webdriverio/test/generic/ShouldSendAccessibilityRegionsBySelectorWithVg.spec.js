// should send accessibility regions by selector with vg
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'should send accessibility regions by selector with vg',
  ...
  it('should send accessibility regions by selector with vg', async () => {
    await spec.visit(
      driver,
