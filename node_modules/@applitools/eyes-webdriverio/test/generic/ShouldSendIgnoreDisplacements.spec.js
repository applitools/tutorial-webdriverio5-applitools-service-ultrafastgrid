...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName: 'should send ignore displacements ',
      baselineName: 'TestIgnoreDisplacements',
    })
  })
  afterEach(async () => {
  ...
  it('should send ignore displacements ', async () => {
    await spec.visit(
      driver,
