...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'should send ignore region by coordinates in target region with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'TestCheckRegionWithIgnoreRegion_Fluent_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('should send ignore region by coordinates in target region with scroll stitching', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckRegionWithIgnoreRegion_Fluent_Scroll',
