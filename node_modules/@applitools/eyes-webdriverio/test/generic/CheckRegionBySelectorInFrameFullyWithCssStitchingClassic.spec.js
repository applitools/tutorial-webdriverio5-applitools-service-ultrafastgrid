// check region by selector in frame fully with css stitching classic
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check region by selector in frame fully with css stitching classic',
      stitchMode: 'CSS',
      baselineName: 'TestCheckRegionInFrame',
    })
  })
  afterEach(async () => {
  ...
  it('check region by selector in frame fully with css stitching classic', async () => {
    await spec.visit(
      driver,
