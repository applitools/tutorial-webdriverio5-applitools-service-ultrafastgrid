...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check region by selector in frame multiple times with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'TestCheckRegionInFrame2_Fluent_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('check region by selector in frame multiple times with scroll stitching', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckRegionInFrame2_Fluent_Scroll',
