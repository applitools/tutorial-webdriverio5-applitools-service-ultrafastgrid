// should send ignore region by selector with css stitching
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName: 'should send ignore region by selector with css stitching',
      stitchMode: 'CSS',
  ...
  it('should send ignore region by selector with css stitching', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.check({ignoreRegions: ['#overflowing-div']})
