...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check window fully and frame in frame fully with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'TestCheckFrameInFrame_Fully_Fluent2_Scroll',
      branchName: 'v2',
    })
  })
  afterEach(async () => {
  ...
  it('check window fully and frame in frame fully with scroll stitching', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckFrameInFrame_Fully_Fluent2_Scroll',
