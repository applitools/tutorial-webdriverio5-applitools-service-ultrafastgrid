...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'should send floating region by coordinates with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'TestCheckWindowWithFloatingByRegion_Fluent_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('should send floating region by coordinates with scroll stitching', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckWindowWithFloatingByRegion_Fluent_Scroll',
