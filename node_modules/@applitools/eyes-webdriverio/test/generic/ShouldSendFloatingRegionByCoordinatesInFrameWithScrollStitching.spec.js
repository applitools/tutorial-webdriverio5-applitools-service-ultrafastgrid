...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'should send floating region by coordinates in frame with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'TestCheckRegionInFrame3_Fluent_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('should send floating region by coordinates in frame with scroll stitching', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckRegionInFrame3_Fluent_Scroll',
