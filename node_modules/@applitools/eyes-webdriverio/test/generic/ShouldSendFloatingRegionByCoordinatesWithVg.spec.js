// should send floating region by coordinates with vg
...
describe.skip('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'should send floating region by coordinates with vg',
      baselineName: 'TestCheckWindowWithFloatingByRegion_Fluent_VG',
    })
  })
  afterEach(async () => {
  ...
  it('should send floating region by coordinates with vg', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckWindowWithFloatingByRegion_Fluent_VG',
