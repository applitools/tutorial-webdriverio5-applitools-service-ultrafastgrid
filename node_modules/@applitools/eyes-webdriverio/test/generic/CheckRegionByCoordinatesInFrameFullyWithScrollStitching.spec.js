...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check region by coordinates in frame fully with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'TestCheckRegionByCoordinateInFrameFully_Fluent_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('check region by coordinates in frame fully with scroll stitching', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckRegionByCoordinateInFrameFully_Fluent_Scroll',
