...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'check region by coordinates in frame with vg',
      baselineName: 'TestCheckRegionByCoordinateInFrame_Fluent_VG',
    })
  })
  afterEach(async () => {
  ...
  it('check region by coordinates in frame with vg', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckRegionByCoordinateInFrame_Fluent_VG',
