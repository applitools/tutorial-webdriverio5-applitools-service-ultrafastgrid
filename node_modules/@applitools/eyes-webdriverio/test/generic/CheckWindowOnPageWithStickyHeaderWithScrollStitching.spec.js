...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check window on page with sticky header with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'TestCheckPageWithHeader_Window_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('check window on page with sticky header with scroll stitching', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckPageWithHeader_Window_Scroll',
