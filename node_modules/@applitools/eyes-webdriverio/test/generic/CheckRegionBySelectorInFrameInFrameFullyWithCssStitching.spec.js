// check region by selector in frame in frame fully with css stitching
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check region by selector in frame in frame fully with css stitching',
      stitchMode: 'CSS',
      baselineName: 'TestCheckRegionInFrameInFrame_Fluent',
    })
  })
  afterEach(async () => {
  ...
  it('check region by selector in frame in frame fully with css stitching', async () => {
    await spec.visit(
      driver,
