...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName: 'should hide and restore scrollbars with css stitching',
      stitchMode: 'CSS',
      baselineName: 'TestScrollbarsHiddenAndReturned_Fluent',
    })
  })
  afterEach(async () => {
  ...
  it('should hide and restore scrollbars with css stitching', async () => {
    await spec.visit(
      driver,
