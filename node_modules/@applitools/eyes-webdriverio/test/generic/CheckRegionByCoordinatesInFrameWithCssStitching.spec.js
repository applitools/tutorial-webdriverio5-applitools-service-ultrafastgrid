// check region by coordinates in frame with css stitching
...
describe.skip('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName: 'check region by coordinates in frame with css stitching',
      stitchMode: 'CSS',
  ...
  it('check region by coordinates in frame with css stitching', async () => {
    await spec.visit(
      driver,
