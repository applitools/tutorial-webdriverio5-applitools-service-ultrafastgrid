// should send ignore region by the same selector as target region with scroll stitching
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      ...
      stitchMode: 'Scroll',
      baselineName:
        'TestCheckElementWithIgnoreRegionBySameElement_Fluent_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('should send ignore region by the same selector as target region with scroll stitching', async () => {
    await spec.visit(
      driver,
