// check window fully on android chrome emulator on mobile page
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check window fully on android chrome emulator on mobile page',
      baselineName: 'Android Emulator 8.0 Portrait mobile fully',
  ...
  it('check window fully on android chrome emulator on mobile page (@native @mobile @headfull)', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'Android Emulator 8.0 Portrait mobile fully',
      undefined
    )
