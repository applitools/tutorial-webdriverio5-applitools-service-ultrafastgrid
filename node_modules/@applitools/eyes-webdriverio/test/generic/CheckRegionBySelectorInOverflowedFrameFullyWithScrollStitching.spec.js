...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check region by selector in overflowed frame fully with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'CheckRegionInFrameLargerThenViewport_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('check region by selector in overflowed frame fully with scroll stitching', async () => {
    await spec.visit(
      driver,
