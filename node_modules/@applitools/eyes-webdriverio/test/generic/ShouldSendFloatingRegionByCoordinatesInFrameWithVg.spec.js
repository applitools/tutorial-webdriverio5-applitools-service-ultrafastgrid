// should send floating region by coordinates in frame with vg
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      ...
      displayName:
        'should send floating region by coordinates in frame with vg',
      baselineName: 'TestCheckRegionInFrame3_Fluent_VG',
    })
  })
  afterEach(async () => {
  ...
  it('should send floating region by coordinates in frame with vg', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.open(
      ...
      'TestCheckRegionInFrame3_Fluent_VG',
