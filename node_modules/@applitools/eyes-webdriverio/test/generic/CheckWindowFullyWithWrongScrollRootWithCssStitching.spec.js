// check window fully with wrong scroll root with css stitching
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'check window fully with wrong scroll root with css stitching',
      stitchMode: 'CSS',
      baselineName: 'TestCheckWindow_Html',
    })
  })
  afterEach(async () => {
  ...
  it('check window fully with wrong scroll root with css stitching', async () => {
    await spec.visit(
      driver,
