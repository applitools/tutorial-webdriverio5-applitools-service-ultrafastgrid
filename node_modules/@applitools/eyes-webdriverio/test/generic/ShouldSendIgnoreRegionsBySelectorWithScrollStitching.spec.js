...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      ...
      stitchMode: 'Scroll',
      baselineName:
        'TestCheckFullWindowWithMultipleIgnoreRegionsBySelector_Fluent_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('should send ignore regions by selector with scroll stitching', async () => {
    await spec.visit(
      driver,
